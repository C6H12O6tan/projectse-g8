...
export default function SettingsPage() {
  ...
  // ⬇️ ให้เฉพาะ "อาจารย์"
  const canAccess = (r: Role | null) => r === 'teacher';
      ...
      <>
        ...
        <Box className="container" sx={{ py: 6, textAlign: 'center' }}>
          ...
          <Typography variant="body2" sx={{ mt: 1, opacity: .8 }}>
            เฉพาะผู้ใช้ที่เข้าสู่ระบบ (Teacher) เท่านั้น
          </Typography>
        </Box>
      </>
    );
    ...
    <>
      ...
      <Box className="container" sx={{ py: 3, display: 'grid', gap: 2 }}>
        ...
        <Dialog open={confirmOpen} onClose={() => setConfirmOpen(false)}>
          ...
          <DialogActions>
            <Button onClick={() => { setConfirmOpen(false); setEditing(false); router.push('/teacher'); }}>ยกเลิก</Button>
